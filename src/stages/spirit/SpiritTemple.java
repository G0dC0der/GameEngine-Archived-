...
public class SpiritTemple extends Stage
{
	...
	public void init() 
	{
		try
		{
			...
			spikeImg    = new Image2D("res/sand/spike.png",true);
			...
			efist1		= new Image2D("res/sand/efist1.png",true);
			efist2		= new Image2D("res/sand/efist2.png",true);
			sfist1		= new Image2D("res/sand/sfist1.png",true);
			sfist2		= new Image2D("res/sand/sfist2.png",true);
			nfist1		= new Image2D("res/sand/nfist1.png",true);
			nfist2		= new Image2D("res/sand/nfist2.png",true);
